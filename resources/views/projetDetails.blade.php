@include('sections.header')
    ...
    <section class="projects-details-area pt-40 pb-130 rpb-100 rel z-1">
            <div class="container">
                ...
                <div class="row gap-120 container-xxl py-6 pt-5">
                    <div class="col-lg-8 ">
                        <div class="project-details-content wow fadeInUp delay-0-2s">
                            <h1 class="titre display-5 mb-0 ">We Create digital Product For Business</h1>
               ...
               <!-- LA PLACE DE MES IMAGES FIN -->
               
                <div class="tag-share py-30 wow fadeInUp delay-0-2s">
                    <div class="item" margin-bottom:25px></div>
                    <div class="item">
                        <b>Share</b>
